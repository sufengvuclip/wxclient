...
public class BigDataWay {
    ...
    public String postArticle(FeedArticle article){
        ...
        try {
            ...
            String response = HttpClientUtil.httpPostRequest(DrupalConstant.articlePostUrl,body,headers,false,null,false);
    ...
    public String addTag(String tag){
        ...
        try {
            String response = HttpClientUtil.httpPostRequest(DrupalConstant.tagPostUrl,body,headers,false,null,false);
            JSONObject root = new JSONObject(response);
    ...
    public String buildArticlePostBody(FeedArticle article){
        ...
        if(StringUtils.trimToNull(originUrl)==null || "null".equalsIgnoreCase(originUrl.trim())) {
